...
class Company{
  constructor(name){     //Конструктор
    ...
    this._pCaption = null;    //ссылка на заголовок очереди отделений
    this._pFirst = null;    //ссылка на первый элемент очереди отделений
  ...
  set addDepartment(newDepartment){}       //Сеттер добавления отделения
  deleteDepartment(){}       //Метод удаления отделения
  searchDepartment(departmentName){}  //Метод поиска отделения
  chooseDepartment(){}       //Метод выбора отделения, с которым будем работать
